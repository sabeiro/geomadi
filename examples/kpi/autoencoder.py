...
dlX = t_r.isocalInWeek(dirc,isBackfold=False,roll=0)
...
if False:
    corL.to_csv(baseDir + "raw/"+custD+"/scor/scor_noBack_"+version+".csv",index=False)
    corX.to_csv(baseDir + "raw/"+custD+"/scor/scor_ext_noBack_"+version+".csv",index=False)
    tK.saveModel(baseDir + "train/"+custD+"/mod_noBack_"+version)
