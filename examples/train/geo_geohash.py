...
def edgeSize(precision):
        precDx = {1:22.500000000,2:5.625000000,3:0.703125000,4:0.175781250,5:0.021972656,6:0.005493164,7:0.000686646,8:0.000171661,9:0.000021458,10:0.000005364,11:0.000000671,12:0.000000168,13:0.000000021,14:0.000000005,15:0.000000001,16:0.000000000}
        precDy = {1:45.0000000000,2:11.2500000000,3:1.4062500000,4:0.3515625000,5:0.0439453125,6:0.0109863281,7:0.0013732910,8:0.0003433228,9:0.0000429153,10:0.0000107288,11:0.0000013411,12:0.0000003353,13:0.0000000419,14:0.0000000105,15:0.0000000013,16:0.0000000003}
        # lact.loc[:,"dy"] = lact['geohash'].apply(lambda x: 180./(2**((5*len(x)+(len(x)%2)))/2-1)   )
        return (precDx[precision]*(1-0.05),precDy[precision]*(1-0.05))
